...
ALTER TABLE `resource_conf` ADD `price` FLOAT UNSIGNED NOT NULL DEFAULT '0' AFTER `description`, ADD `furniturelist` VARCHAR(3000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER `price`;